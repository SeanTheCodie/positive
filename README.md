...
The app uses realistic sample UK company data so the product flow works without API keys. The code is structured so Companies House, news, social, and Glassdoor providers can be connected later.

## Included MVP Flow

- Saved watchlists for tracked companies
